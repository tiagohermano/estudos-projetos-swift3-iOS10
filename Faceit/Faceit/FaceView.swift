...
class FaceView: UIView {
    ...
    private func pathForMouth() -> UIBezierPath {
        ...
        let mouthRect = CGRect(x: skullCenter.x - mouthOffset, y: skullCenter.y + mouthOffset, width: mouthWidth, height: mouthHeight)
        ...
        let cp2 = CGPoint(x: end.x - mouthRect.width / 2, y: start.y + smileOffset)
