...
class UserCell: DatasourceCell {
    ...
    let bioTextView: UITextView = {
        ...
        textView.text = "iPhone, iPad, iOS Programming Comunity. Join us to learn Swift, Objective-C and build iOS apps!"
